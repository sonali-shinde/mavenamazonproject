...
public class toverifyAddToCart extends Base{
	WebDriver driver;
	Header header;
	...
	public void toVerifyWatch()
	{
		...
		Assert.assertEquals(url, "https://www.amazon.in/gp/buy/addressselect/handlers/display.html?hasWorkingJavascript=1");
		Assert.assertEquals(title,"Select a delivery address");
